...
namespace MVVM2.ViewModels
{
    public class OperationsViewModel : ViewModelBase
    {
        ...
        #region Comandos
        public ICommand Sumar
        { protected set; get; }

        public ICommand Restar
        { protected set; get; }

        public ICommand Dividir
        { protected set; get; }

        public ICommand Multiplicar
        { protected set; get; }
        #endregion
        ...
        public OperationsViewModel()
        {
            ...
            Dividir = new Command(() =>
            {
                ResultDividir = Valor1 / (Valor2 * 1.0);
            });
